...
CEImage.prototype.onload = function() {
	// Override this if you want
};

CEImage.prototype.getSize = function() {
	return {
...
CEImage.prototype.setSize = function(size) {
...
CEImage.prototype.fitMaxBounds = function(bounds) {
...
CEImage.prototype.draw = function() {
	if (this.readyToDraw){
